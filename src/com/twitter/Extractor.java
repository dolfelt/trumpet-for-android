...
public class Extractor {
  public static class Entity {
    ...
    public Entity(Matcher matcher, String valueType, Integer groupNumber) {
      this.start = matcher.start(groupNumber); // 0-indexed.
  ...
  public static List<String> extractMentionedScreennamesText(String text) {
	    if (text == null) {
	      return null;
	    }
   ...
   */
  public static List<Entity> extractMentionedScreennames(String text) {
    if (text == null) {
      return null;
    }
   ...
   */
  public static String extractReplyScreenname(String text) {
    if (text == null) {
      return null;
    }
   ...
   */
  public static List<Entity> extractURLs(String text) {
    if (text == null) {
      return null;
    }

    return extractListWithIndices(Regex.VALID_URL, text, Regex.VALID_URL_GROUP_URL, "url");
  }
   ...
   */
  public static List<Entity> extractHashtags(String text) {
    if (text == null) {
      return null;
    }
  ...
  private static List<Entity> extractListWithIndices(Pattern pattern, String text, int groupNumber, String valueType) {
    List<Entity> extracted = new ArrayList<Entity>();
    Matcher matcher = pattern.matcher(text);
