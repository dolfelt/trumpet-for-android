...
public class UserAutoComplete extends AutoCompleteTextView {
	private String previous = "";
	private String next = "";
	private String seperator = " ";
	public UserAutoComplete(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		this.setThreshold(0);
	}

	public UserAutoComplete(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		this.setThreshold(0);
	}

	public UserAutoComplete(final Context context) {
		super(context);
		this.setThreshold(0);
	}
	...
	*/
	...
	protected void replaceText(final CharSequence text) {
		  ...
		  super.replaceText(text.toString().substring(1));
	}
